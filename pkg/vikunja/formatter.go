...
func (f *Formatter) FormatProjects(projects []Project) error {
	if f.useColor {
		...
		fmt.Fprintln(f.output, headerColor.Sprint("PROJECTS"))
	...
	if f.useColor {
		...
		fmt.Fprintln(w, headerColor.Sprint("NAME")+"\t"+headerColor.Sprint("ID")+"\t"+headerColor.Sprint("URI"))
	} else {
		fmt.Fprintln(w, "NAME\tID\tURI")
	}
...
func (f *Formatter) FormatTasks(tasks []Task) error {
	if f.useColor {
		headerColor := color.New(color.FgCyan, color.Bold)
		fmt.Fprintln(f.output, headerColor.Sprint("TASKS"))
		fmt.Fprintln(f.output)
	}
	...
	if f.useColor {
		headerColor := color.New(color.FgYellow, color.Bold)
		fmt.Fprintln(w, headerColor.Sprint("TITLE")+"\t"+headerColor.Sprint("ID")+"\t"+headerColor.Sprint("BUCKET")+"\t"+headerColor.Sprint("URI"))
	} else {
		fmt.Fprintln(w, "TITLE\tID\tBUCKET\tURI")
	}
...
func (f *Formatter) FormatBuckets(buckets []Bucket) error {
	...
	fmt.Fprintln(w, headerColor.Sprint("TITLE")+"\t"+headerColor.Sprint("ID")+"\t"+headerColor.Sprint("DONE")+"\t"+headerColor.Sprint("POSITION"))
...
func (f *Formatter) FormatProjectViews(views []ProjectView) error {
	...
	fmt.Fprintln(w, headerColor.Sprint("TITLE")+"\t"+headerColor.Sprint("ID")+"\t"+headerColor.Sprint("KIND")+"\t"+headerColor.Sprint("POSITION"))
