# MCP Create Task Specification

## Purpose

This specification defines the requirements for creating new tasks in Vikunja through the MCP server. It covers the `create_task` tool that allows AI assistants and other MCP clients to programmatically create tasks with flexible project and bucket assignment.
